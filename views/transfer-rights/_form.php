...
<div class="invoice-load-in-form">
	...
	<div class="col-sm-6 col-xs-12">
	<?= $form->field($model, 'user2')->textInput(['id' => 'userName', 'placeholder' => 'Email']); //not involved in form saving, just to get value (Id of user) from autocmplete and set it to {user_kontagent_id} ?>
	</div>
	
	<div class="col-sm-6 col-xs-12">
    <?= $form->field($model, 'to_user_id')->textInput(['id' => 'userID', 'value'=> 'will be hidden field', 'placeholder' => 'User ID']) ?> <!-- hiddenInput(['value'=> '', 'id' => 'some_id'])->label(false); -->
    </div>
